            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="resetcustomerpasswordaction.php" method="post">
                            <fieldset>
                            <div class="form-group">
                                    <input class="form-control" placeholder="Customer name " name="name" type="name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder=" Type password " name="typepassword" type="password">
                                </div>
